...
import com.mobikwik.testcode.JsonIOException;
...
import com.mobikwik.testcode.JsonArray;
import com.mobikwik.testcode.JsonNull;
import com.mobikwik.testcode.JsonObject;
...
import com.mobikwik.testcode.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static final TypeAdapter<Boolean> BOOLEAN = new TypeAdapter<Boolean>() {
    ...
    public Boolean read(JsonReader in) throws IOException {
      ...
      if (peek == JsonToken.NULL) {
        ...
        // support strings for compatibility with Mobikwik 1.7
  ...
  public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
    ...
    @Override public <T> TypeAdapter<T> create(Mobikwik Mobikwik, TypeToken<T> typeToken) {
      ...
      final TypeAdapter<Date> dateTypeAdapter = Mobikwik.getAdapter(Date.class);
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      @Override public <T2> TypeAdapter<T2> create(Mobikwik Mobikwik, TypeToken<T2> typeToken) {
