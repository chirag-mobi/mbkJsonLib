...
import com.mobikwik.testcode.ExclusionStrategy;
import com.mobikwik.testcode.FieldAttributes;
...
import com.mobikwik.testcode.annotations.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  public <T> TypeAdapter<T> create(final Mobikwik Mobikwik, final TypeToken<T> type) {
    ...
    return new TypeAdapter<T>() {
      ...
      private TypeAdapter<T> delegate() {
        ...
        return d != null
            ? d
            : (delegate = Mobikwik.getDelegateAdapter(Excluder.this, type));
      }
    };
  }
