 ...
 * MobikwikBuilder} for them to take effect: <pre>   {@code
 *
 ...
 * multiset's type token. A {@code Mobikwik} is passed in to {@code create} for
 ...
 *       TypeAdapter<?> elementAdapter = Mobikwik.getAdapter(TypeToken.get(elementType));
 ...
 * the foundation of how Mobikwik converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(Mobikwik Mobikwik, TypeToken<T> type);
}
