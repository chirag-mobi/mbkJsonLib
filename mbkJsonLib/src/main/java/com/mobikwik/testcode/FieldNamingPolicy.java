 ...
 * This enumeration should be used in conjunction with {@link MobikwikBuilder}
 * to configure a {@link Mobikwik} instance to properly translate Java field
...
public enum FieldNamingPolicy implements FieldNamingStrategy {
  ...
  /**
   * Using this naming policy with Mobikwik will ensure that the field name is
   * unchanged.
   */
  IDENTITY() {
  ...
  /**
   * Using this naming policy with Mobikwik will ensure that the first "letter" of the Java
  ...
  /**
   * Using this naming policy with Mobikwik will modify the Java Field name from its camel cased
