...
/**
 * An annotation that indicates the Mobikwik {@link TypeAdapter} to use with a class
 * or field.
 *
 ...
 * field's type, and in the {@link MobikwikBuilder}. Field
 * annotations take precedence over {@code MobikwikBuilder}-registered type
 ...
 * to the enclosing {@code Mobikwik} instance.
 *
 * @since 2.3
 *
